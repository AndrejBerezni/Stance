...
export const tooltipVariants = cva(
  'absolute z-50 whitespace-nowrap pointer-events-none bg-foreground text-background tracking-wide px-3 text-xs font-medium py-2 rounded-md',
  {
    variants: {
      position: {
...
export const arrowVariants = cva('absolute h-0 w-0', {
  variants: {
    position: {
      top: 'left-1/2 -translate-x-1/2 -translate-y-1/4 top-full border-l-9 border-l-transparent border-t-9 border-t-foreground border-r-9 border-r-transparent',
      bottom:
      ...
      left: 'left-full -translate-x-1/4 top-1/2 -translate-y-1/2 border-t-9 border-t-transparent border-l-9 border-l-foreground border-b-9 border-b-transparent',
      right:
